    ...
    <main className="flex-1 bg-background px-4 py-10 text-foreground sm:px-6">
      <div className="mx-auto max-w-3xl">
        ...
        {ruolo === "acquirente" ? (
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <Link
              ...
              className="block rounded-xl border border-border bg-surface p-5 shadow-sm outline-none ring-ring transition hover:border-accent hover:shadow-md focus-visible:ring-2"
            >
              <h2 className="text-lg font-semibold text-foreground">Nuova richiesta</h2>
            ...
            <Link
              ...
              className="block rounded-xl border border-border bg-surface p-5 shadow-sm outline-none ring-ring transition hover:border-accent hover:shadow-md focus-visible:ring-2"
            >
              <h2 className="text-lg font-semibold text-foreground">Le mie richieste</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <Link
              ...
              className="block rounded-xl border border-border bg-surface p-5 shadow-sm outline-none ring-ring transition hover:border-accent hover:shadow-md focus-visible:ring-2"
            >
              <h2 className="text-lg font-semibold text-foreground">Richieste in arrivo</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
        ...
        <p className="mt-8 text-sm text-muted">
          ...
          <Link href="/area-personale" className="font-medium text-primary underline">
            Area personale
          </Link>
          .
        </p>
